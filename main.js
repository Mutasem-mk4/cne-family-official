...
const COMMON_PLAN_HOTSPOTS = [
  // COL 11 (Far Right)
  ["إنجليزي تطبيقي 1", 3248, 168, 252, 170],
  ["إنجليزي تطبيقي 2", 3248, 473, 252, 170],
  ["الكتابة التقنية والأخلاقيات المهنية", 3248, 952, 252, 170],
  ["الاقتصاد الهندسي", 3248, 1192, 252, 170],
  ["تدريب ميداني", 3248, 1429, 252, 170],
  ["الإسلام والحياة", 3248, 1924, 252, 170],

  // COL 10 (Orange/National)
  ["اللغة العربية التطبيقية", 2933, 473, 252, 170],
  ["التربية الوطنية", 2933, 713, 252, 170],
  ["الريادة والابتكار", 2933, 954, 252, 170],
  ["العلوم العسكرية", 2933, 1195, 252, 170],

  // COL 9 (Prob/Linear/Projects)
  ["إحصاء واحتمالات للهندسة", 2617, 168, 252, 170],
  ["الجبر الخطي", 2617, 672, 252, 170],
  ["إتصالات وتراسل بيانات", 2617, 924, 252, 170],
  ["مشروع تخرج 1", 2617, 1429, 252, 170],
  ["مشروع تخرج 2", 2617, 1681, 252, 170],

  // COL 8 (Calc)
  ["تفاضل وتكامل 1", 2302, 168, 252, 170],
  ["تفاضل وتكامل 2", 2302, 420, 252, 170],
  ["تقنيات عددية", 2302, 672, 252, 170],
  ["أنظمة وإشارات", 2302, 924, 252, 170],

  // COL 7 (Phys/Circuits)
  ["الفيزياء العامة 1", 1987, 168, 252, 170],
  ["الفيزياء العامة 2", 1987, 420, 252, 170],
  ["المعادلات التفاضلية العادية", 1987, 672, 252, 170],
  ["إلكترونيات 1", 1987, 924, 252, 170],
  ["مختبر إلكترونيات 1", 1987, 1429, 252, 170],

  // COL 6 (Workshop/Circuits)
  ["المشغل الهندسي", 1672, 168, 252, 170],
  ["مختبر الفيزياء العامة", 1672, 420, 252, 170],
  ["دوائر كهربائية 1", 1672, 672, 252, 170],
  ["دوائر كهربائية 2", 1672, 924, 252, 170],
  ["مختبر دوائر كهربائية", 1672, 1429, 252, 170],

  // COL 5 (Drawing/Database)
  ["الرسم الهندسي", 1356, 168, 252, 170],
  ["البرمجة بلغة الكينونة", 1356, 420, 252, 170],
  ["تراكيب البيانات والخوارزميات", 1356, 672, 252, 85],
  ["مختبر تراكيب البيانات والخوارزميات", 1356, 757, 252, 85],
  ["أنظمة قواعد البيانات", 1356, 924, 252, 85],
  ["مختبر أنظمة قواعد البيانات", 1356, 1009, 252, 85],

  // COL 4 (CompSkills/Arch)
  ["مهارات الحاسوب", 1041, 168, 252, 170],
  ["البرمجة للمهندسين", 1041, 420, 252, 170],
  ["تصميم المنطق الرقمي", 1041, 672, 252, 85],
  ["مختبر تصميم المنطق الرقمي", 1041, 757, 252, 85],
  ["أنظمة المعالجات الدقيقة", 1041, 924, 252, 85],
  ["مختبر أنظمة المعالجات الدقيقة", 1041, 1009, 252, 85],
  ["معمارية الحاسوب وتنظيمه", 1041, 1176, 252, 85],
  ["مختبر معمارية الحاسوب وتنظيمه", 1041, 1261, 252, 85],

  // COL 3 (Chemistry)
  ["الكيمياء العامة 1", 726, 168, 252, 170],

  // COL 2 (Chemistry Lab)
  ["مختبر الكيمياء العامة", 410, 420, 252, 170],
];

const COMPUTER_PLAN_HOTSPOTS = [
  // COL 9 Y=424 (AI & AI Lab split - now vertical)
  ["الذكاء الاصطناعي وتعلم الآلة", 2617, 420, 252, 85],
  ["مختبر الذكاء الاصطناعي وتعلم الآلة", 2617, 505, 252, 85],

  // COL 9 Y=1180 (Computer Networks 1)
  ["أساسيات شبكات الحاسوب", 2617, 1176, 252, 170],

  // COL 9 Y=1433 (Protocols)
  ["بروتوكولات الشبكات", 2617, 1429, 252, 170],

  // COL 8 Y=1180 (Control systems)
  ["أنظمة التحكم", 2302, 1176, 252, 170],

  // COL 8 Y=1433 (Control Lab)
  ["مختبر أنظمة التحكم", 2302, 1429, 252, 170],

  // COL 8 Y=1685 (Cybersecurity)
  ["أساسيات الأمن السيبراني", 2302, 1681, 252, 170],

  // COL 7 Y=1180 (Digital Electronics)
  ["إلكترونيات رقمية", 1987, 1176, 252, 170],

  // COL 7 Y=1685 (Networks Lab)
  ["مختبر شبكات الحاسوب", 1987, 1681, 252, 170],

  // COL 6 Y=1180 (Electrical Machines)
  ["الآلات كهربائية", 1672, 1176, 252, 170],

  // COL 5 Y=1180 (Operating Systems)
  ["نظم التشغيل", 1356, 1176, 252, 170],

  // COL 5 Y=1433 (Advanced Programming)
  ["برمجة متقدمة", 1356, 1429, 252, 170],

  // COL 4 Y=1433 (Advanced Arch)
  ["معمارية الحواسيب المتقدمة", 1041, 1429, 252, 170],

  // COL 3 Y=1180 (Embedded Systems split - now vertical)
  ["الأنظمة المضمنة", 726, 1176, 252, 85],
  ["مختبر الأنظمة المضمنة", 726, 1261, 252, 85],

  // COL 2 Y=1433 (Parallel Lab)
  ["مختبر أنظمة المعالجات المتوازية", 410, 1429, 252, 170],

  // COL 1 (Computer Electives)
  ["موضوعات خاصة", 95, 168, 252, 170],
  ["المنطق المشوش", 95, 420, 252, 170],
  ["تصميم رقمي متقدم", 95, 672, 252, 170],
  ["تقييم أداء الحاسوب", 95, 924, 252, 170],
  ["الحوسبة السحابية", 95, 1176, 252, 170],
  ["إنترنت الأشياء", 95, 1429, 252, 170],
  ["معالجة الصور الرقمية", 95, 1681, 252, 170]
];
