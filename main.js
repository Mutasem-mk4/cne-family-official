...
const COMMON_PLAN_HOTSPOTS = [
  ...
  // COL: Arabic/National
  ["اللغة العربية التطبيقية", 1310, 115, 105, 70],
  ["التربية الوطنية", 1310, 225, 105, 70],
  ["الريادة والابتكار", 1310, 335, 105, 70],
  ["العلوم العسكرية", 1310, 445, 105, 70],

  // COL: Prob/AI/Linear
  ["إحصاء واحتمالات للهندسة", 1185, 115, 105, 70],
  ["الذكاء الاصطناعي وتعلم الآلة", 1215, 225, 60, 70],
  ["مختبر الذكاء الاصطناعي وتعلم الآلة", 1145, 225, 60, 70],
  ["الجبر الخطي", 1185, 335, 105, 70],
  ["إتصالات وتراسل بيانات", 1185, 445, 105, 70],
  ["أساسيات شبكات الحاسوب", 1185, 555, 105, 70],
  ["بروتوكولات الشبكات", 1185, 645, 105, 70],
  ["أساسيات الأمن السيبراني", 1055, 755, 105, 70],

  // COL: Calc/Control
  ["تفاضل وتكامل 1", 1055, 115, 105, 70],
  ["تفاضل وتكامل 2", 1055, 225, 105, 70],
  ["تقنيات عددية", 1055, 335, 105, 70],
  ["أنظمة وإشارات", 1055, 445, 105, 70],
  ["أنظمة التحكم", 1055, 555, 105, 70],
  ["مختبر أنظمة التحكم", 1055, 645, 105, 70],
  ["مختبر شبكات الحاسوب", 925, 755, 105, 70],

  // COL: Phys/Circuits
  ["الفيزياء العامة 1", 925, 115, 105, 70],
  ["الفيزياء العامة 2", 925, 225, 105, 70],
  ["المعادلات التفاضلية العادية", 925, 335, 105, 70],
  ["إلكترونيات 1", 925, 445, 105, 70],
  ["إلكترونيات رقمية", 925, 555, 105, 70],
  ["مختبر إلكترونيات 1", 925, 645, 105, 70],

  // COL: Workshop/Embedded
  ["المشغل الهندسي", 795, 115, 105, 70],
  ["مختبر الفيزياء العامة", 795, 225, 105, 70],
  ["دوائر كهربائية 1", 795, 335, 105, 70],
  ["دوائر كهربائية 2", 795, 445, 105, 70],
  ["الآلات كهربائية", 795, 555, 105, 70],
  ["مختبر دوائر كهربائية", 795, 645, 105, 70],

  // COL: Drawing/OS
  ["الرسم الهندسي", 665, 115, 105, 70],
  ["البرمجة بلغة الكينونة", 665, 225, 105, 70],
  ["مختبر تراكيب البيانات والخوارزميات", 695, 335, 60, 70],
  ["تراكيب البيانات والخوارزميات", 625, 335, 60, 70],
  ["مختبر أنظمة قواعد البيانات", 695, 445, 60, 70],
  ["أنظمة قواعد البيانات", 625, 445, 60, 70],
  ["نظم التشغيل", 665, 555, 105, 70],
  ["برمجة متقدمة", 665, 645, 105, 70],

  // COL: CompSkills/Arch
  ["مهارات الحاسوب", 535, 115, 105, 70],
  ["البرمجة للمهندسين", 535, 225, 105, 70],
  ["تصميم المنطق الرقمي", 565, 335, 60, 70],
  ["مختبر تصميم المنطق الرقمي", 495, 335, 60, 70],
  ["أنظمة المعالجات الدقيقة", 565, 445, 60, 70],
  ["مختبر أنظمة المعالجات الدقيقة", 495, 445, 60, 70],
  ["معمارية الحاسوب وتنظيمه", 565, 555, 60, 70],
  ["مختبر معمارية الحاسوب وتنظيمه", 495, 555, 60, 70],
  ["معمارية الحواسيب المتقدمة", 535, 645, 105, 70],

  // COL: Chem/Embedded
  ["الكيمياء العامة 1", 405, 115, 105, 70],
  ["مختبر الكيمياء العامة", 405, 225, 105, 70],
  ["الأنظمة المضمنة", 435, 555, 60, 70],
  ["مختبر الأنظمة المضمنة", 365, 555, 60, 70],
  ["مختبر أنظمة المعالجات المتوازية", 405, 645, 105, 70],
];

const COMPUTER_PLAN_HOTSPOTS = [
  // ELECTIVES (Red - Far Left)
