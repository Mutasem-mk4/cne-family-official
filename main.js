...
const COMMON_PLAN_HOTSPOTS = [
  // ROW 1
  ["الكيمياء العامة 1", 164, 110, 108, 75],
  ["مهارات الحاسوب", 298, 110, 108, 75],
  ["الرسم الهندسي", 432, 110, 108, 75],
  ["المشغل الهندسي", 566, 110, 108, 75],
  ["الفيزياء العامة 1", 700, 110, 108, 75],
  ["التفاضل والتكامل 1", 834, 110, 108, 75],
  ["الإحصاء والاحتمالات للمهندسين", 968, 110, 108, 75],

  // ROW 2
  ["مختبر الكيمياء العامة", 164, 218, 108, 75],
  ["البرمجة للمهندسين (C++)", 298, 218, 108, 75],
  ["البرمجة بلغة الكينونة", 432, 218, 108, 75],
  ["مختبر الفيزياء العامة 1", 566, 218, 108, 75],
  ["الفيزياء العامة 2", 700, 218, 108, 75],
  ["التفاضل والتكامل 2", 834, 218, 108, 75],
  ["الذكاء الاصطناعي وتعلم الآلة", 968, 218, 108, 75],

  // ROW 3
  ["مختبر تصميم المنطق الرقمي", 164, 326, 108, 75],
  ["تصميم المنطق الرقمي", 298, 326, 108, 75],
  ["تراكيب البيانات والخوارزميات", 432, 326, 108, 75],
  ["مختبر تراكيب البيانات والخوارزميات", 566, 326, 108, 75],
  ["الدوائر الكهربائية 1", 700, 326, 108, 75],
  ["المعادلات التفاضلية العادية", 834, 326, 108, 75],
  ["التقنيات العددية", 968, 326, 108, 75],
  ["الجبر الخطي", 1102, 326, 108, 75],

  // ROW 4
  ["مختبر أنظمة المعالجات الدقيقة", 164, 434, 108, 75],
  ["أنظمة المعالجات الدقيقة", 298, 434, 108, 75],
  ["أنظمة قواعد البيانات", 432, 434, 108, 75],
  ["مختبر قواعد البيانات", 566, 434, 108, 75],
  ["الدوائر الكهربائية 2", 700, 434, 108, 75],
  ["الإلكترونيات 1", 834, 434, 108, 75],
  ["الأنظمة والإشارات", 968, 434, 108, 75],
  ["اتصالات وتراسل البيانات", 1102, 434, 108, 75],

  // ROW 5
  ["مختبر بنية ومعمارية الحاسوب", 164, 542, 108, 75],
  ["بنية ومعمارية الحاسوب", 298, 542, 108, 75],
  ["نظم التشغيل", 432, 542, 108, 75],
  ["الأنظمة المضمنة", 566, 542, 108, 75],
  ["الآلات الكهربائية", 700, 542, 108, 75],
  ["الإلكترونيات الرقمية", 834, 542, 108, 75],
  ["أنظمة التحكم الآلي", 968, 542, 108, 75],

  // ROW 6
  ["مختبر أنظمة المعالجات المتوازية", 164, 650, 108, 75],
  ["بنية الحاسوب المتقدمة", 298, 650, 108, 75],
  ["البرمجة المتقدمة", 432, 650, 108, 75],
  ["مختبر الأنظمة المضمنة", 566, 650, 108, 75],
  ["مختبر دوائر كهربائية", 700, 650, 108, 75],
  ["مختبر الإلكترونيات 1", 834, 650, 108, 75],
  ["مختبر أنظمة التحكم", 968, 650, 108, 75],
  ["أساسيات شبكات الحاسوب", 1102, 650, 108, 75],

  // ROW 7
  ["مختبر شبكات الحاسوب", 834, 758, 108, 75],
  ["أساسيات الأمن السيبراني", 968, 758, 108, 75],
  ["بروتوكولات الشبكات", 1102, 758, 108, 75],

  // SIDEBAR (Orange/Blue)
  ["اللغة العربية التطبيقية", 1250, 150, 108, 75],
  ["اللغة الإنجليزية 1", 1384, 150, 108, 75],
  ["التربية الوطنية", 1250, 258, 108, 75],
  ["اللغة الإنجليزية 2", 1384, 258, 108, 75],
  ["الريادة والابتكار", 1250, 366, 108, 75],
  ["الكتابة التقنية والمهارات الحيايتة", 1384, 366, 108, 75],
  ["العلوم العسكرية", 1250, 474, 108, 75],
  ["الاقتصاد الهندسي", 1384, 474, 108, 75],
  ["مشروع تخرج 1", 1250, 582, 108, 75],
  ["تدريب ميداني", 1384, 582, 108, 75],
  ["مشروع تخرج 2", 1250, 690, 108, 75],
  ["مادتين بواقع 6 ساعات", 1384, 690, 108, 75],

  // RED SIDEBAR (Special Topics)
  ["موضوعات خاصة في هندسة الحاسوب", 30, 110, 108, 75],
  ["المنطق المشوش", 30, 218, 108, 75],
  ["تصميم رقمي متقدم", 30, 326, 108, 75],
  ["تقييم أداء الحاسوب", 30, 434, 108, 75],
  ["الحوسبة السحابية", 30, 542, 108, 75],
  ["إنترنت الأشياء", 30, 650, 108, 75],
  ["معالجة الصور الرقمية", 30, 758, 108, 75],
];

const COMPUTER_PLAN_HOTSPOTS = [];

const NETWORK_PLAN_HOTSPOTS = [
  ["النمذجة والمحاكاة", 30, 110, 108, 75], // Usually replaces topics
  ["الشبكات اللاسلكية", 30, 542, 108, 75],
  ["مختبر أمن الشبكات والإنترنت", 700, 758, 108, 75],
  ["تشفير وأمن أنظمة الشبكات", 834, 758, 108, 75],
  ["برمجة الشبكات", 1102, 758, 108, 75],
];
